...
import { mockBlogPosts, categories, tags } from "../utils/mockData";
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body text-center py-5">
              <h2 className="display-6 fw-bold mb-3">
                Discover Our{" "}
                <span className="text-primary">Extensive Collection</span>
              </h2>
              <p className="lead mb-4">
                Explore over 100 articles across Programming, Web Development,
                Design, Technology, and Tutorials categories
              </p>
